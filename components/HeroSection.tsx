...
export default function HeroSection() {
  ...
  return (
    <section className="min-h-screen bg-blue-800 text-white flex items-center overflow-hidden relative">
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-linear-to-br from-blue-900/20 via-red to-black" />

      <div className="container mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        {/* Left Side - Smooth Carousel */}
              ...
              <div className="relative group">
                ...
                <div className="bg-linear-to-br from-red-500/10 to-rose-500/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-red-500/20">
                  <div className="bg-gray-800/50 border-2 border-dashed border-red-500/30 rounded-2xl w-96 h-96 lg:w-[420px] lg:h-[420px] flex flex-col items-center justify-center relative overflow-hidden">
                    {/* Gradient Overlay */}
                    <div
                      className={`absolute inset-0 bg-linear-to-br ${item.gradient} opacity-85`}
                    />
                  ...
                  <motion.div
                    ...
                    className="absolute -bottom-6 -right-6 bg-linear-to-r from-red-500 to-rose-500 text-white px-10 py-5 rounded-full shadow-2xl font-bold text-2xl flex items-center gap-3"
                  >
            ...
            {carouselItems.map((_, idx) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${
                  idx === currentIndex ? "bg-red-500 w-10" : "bg-gray-600"
                }`}
              />
            ))}
          </div>
        ...
        {/* Right Side - Text & CTA */}
        <div className="space-y-8 max-w-2xl p-5!">
          <motion.div
          ...
          >
            Get consultency nurse and important equipment Hospital at home
            package, Empowering You to Achieve Your Full Potential with
          ...
          <motion.div
            ...
            className="flex gap-6 text-gray-500 pt-8!"
          >
